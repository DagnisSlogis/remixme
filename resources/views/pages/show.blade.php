...
<article>
    <div class="RemixComp">
        ...
        @elseif($comp->status == 'a')
            <span class="comp-left">Gaida apstiprinājumu</span>
        @elseif($comp->subm_end_date < \Carbon\Carbon::now() && $comp->comp_end_date > \Carbon\Carbon::now())
            <span class="comp-left">Vērtēšana</span>
        @else
        ...
        @endif
        <p><b>Apraksts: </b> {{$comp->description}} </p>
        <p><b>Balvas: </b> {{$comp->prizes}}</p>
        <p><b>Noteikumi: </b> {{$comp->rules}}</p>
        <ul class="moreinfo">
        ...
        @if($comp->voting->status == 'v')
            ...
            <ul class="functionbtnfull">
                ...
                <li>
                    <a href="#submit-box" class="submit-window"><button class="subm-window enterbtn" data-id="{{$comp->id}}">Iesniegt</button></a>
                </li>
            </ul>
        @endif
        @if($comp->voting->status == 'b')
